...
allowed-tools: Bash(make *), Bash(scripts/*), Bash(k3d *), Bash(flux *), Bash(kubectl get *), Bash(git status *), Agent(deploy-verifier)
---
...
4. Delegate verification: spawn the `deploy-verifier` agent with the overlay name and paste its PASS/FAIL table verbatim.
